...
const { sseMiddleware } = require("../controllers/WalletSSE");

// ── Real-time wallet updates (Server-Sent Events) ─────────────────────────────
// The browser connects here once and receives push events whenever the balance changes.
router.get  ("/:userId/events",                         sseMiddleware);
